...
output "private_route_table_id" {
  description = "Seoul Private Route Table ID (for Azure VPN routing)"
  value       = data.terraform_remote_state.global_vpc.outputs.seoul_private_route_table_id
}
...
output "beanstalk_environment_url" {
  ...
  depends_on = [aws_elastic_beanstalk_environment.seoul_env]
}
